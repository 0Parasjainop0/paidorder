...
export function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Store in Supabase for admin to see
      await supabaseDb.addMessage({
        name: formData.name,
        email: formData.email,
        subject: formData.subject,
        message: `[${formData.category || 'General'}] ${formData.message}`
      })
      ...
      setLoading(false)
      alert("There was an issue saving your message, but you can still email us directly at shouryachair@gmail.com")
    }
  }
