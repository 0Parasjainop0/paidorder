    ...
    useEffect(() => {
        const initPayment = async () => {
            ...
            try {
                ...
                // Look up seller's stripe_account_id from Supabase
                const seller = firstItem ? await supabaseDb.getUser(firstItem.product.creator_id) : null
