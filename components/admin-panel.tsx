...
import { AuroraBackground, FloatingShapes } from "@/components/ui/animated-backgrounds"
...
export function AdminPanel() {
  ...
  return (
    <div className="min-h-screen py-8 bg-background relative overflow-hidden">
      ...
      {/* Glowing orbs */}
      <div className="absolute top-20 right-[15%] w-64 h-64 bg-gradient-to-br from-ambient-500/10 to-transparent rounded-full blur-3xl animate-float-orb animate-glow-breathe" />
      <div className="absolute bottom-40 left-[10%] w-80 h-80 bg-gradient-to-br from-purple-500/8 to-transparent rounded-full blur-3xl animate-float-orb-reverse" />
                      ...
                      <div className="flex gap-2">
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="creator">Seller</SelectItem>
