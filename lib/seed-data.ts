...
export const SEED_DATA: MockDB = {
    ...
    products: [
        {
            ...
            file_name: null,
            file_size: null,
            seller_stripe_account_id: "acct_test_123"
        },
        {
            id: "prod-2",
            creator_id: "trade-master",
    ...
    messages: [],
    credentials: [
        { email: "shourya-admin.digiteria@gmail.com", password: "shourya91mcDigiteria" },
        { email: "trade@master.com", password: "trade123" },
        { email: "neon@design.com", password: "neon123" }
    ]
}
